...
public class PositionSlateInMiddle : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Calculate and set the position and rotation
        SetSlatePositionAndRotation();
    }

    // Function to calculate and set the position and rotation of the slate
    public void SetSlatePositionAndRotation()
    {
